...
public class IndexController {
    ...
    @Autowired
    private ToutiaoService taotiaoService;
    ...
    public String index(HttpSession session){
        ...
        return  "Hello NowCoder:"+ session.getAttribute("msg")+ taotiaoService.say();
    }
    ...
    public String profile(@PathVariable("groupId") String groupId,
        ...
        return  String.format("GIU{%s},UID{%d},TYPE{%d},KEY{%s}",groupId, userId, type, key);
    ...
    public String news(Model model){
       model.addAttribute("value1","vv1");
        ...
        List<String> colors = Arrays.asList(new String[]{"blue","red","yellow"});
    ...
    @ResponseBody
    public String resuest(HttpServletRequest request,
